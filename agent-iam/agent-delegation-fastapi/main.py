...
async def lifespan(app: FastAPI):
    ...
    Initializes the GL-IAM gateway with Native provider on startup
    ...
    # from_fullstack_provider auto-detects agent_provider from NativeProvider
...
async def delegate_to_agent(
    ...
    # Extract the raw JWT from the Authorization header ("Bearer <token>")
