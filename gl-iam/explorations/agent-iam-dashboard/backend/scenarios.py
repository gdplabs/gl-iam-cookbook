...
SCENARIOS: dict[str, dict] = {
    ...
    "UC-GLCHAT-01.1": {
        ...
        "user_email": "onlee@tenantA.com",
        "agent": "scheduling-agent",
        "message": "Give me a list of my meetings today",
        "tool_inputs": {},
        "resource_context": {
            "target_calendar": "onlee@tenantA.com",
            "access_type": "user",
        },
    ...
    "UC-GLCHAT-01.1-M": {
        ...
        "user_email": "attendee@tenantA.com",
        "agent": "scheduling-agent",
        "message": "Give me a list of my meetings today",
        "tool_inputs": {},
        "resource_context": {
            "target_calendar": "attendee@tenantA.com",
            "access_type": "user",
        },
        "expected_outcome": "success",
        "brd_refs": ["BR-DA-02", "BR-AP-01", "BR-RB-01"],
    ...
    "UC-GLCHAT-01.2": {
        ...
        "concepts": ["Delegated Access", "Agent OAuth", "Resource Constraint"],
    },
    "UC-GLCHAT-01.2-M": {
        "product": "glchat",
        "title": "Check Pak On (CEO) calendar (Member)",
        "description": "Petry (member) checks CEO's meetings. Agent OAuth allowed — Pak On is in the member whitelist.",
        "user_email": "attendee@tenantA.com",
        "agent": "scheduling-agent",
        "message": "Give me a list of Pak On's meetings today",
        "tool_inputs": {},
        "resource_context": {
            "target_calendar": "onlee@tenantA.com",
            "access_type": "agent",
            "agent_calendar_access": ["onlee@tenantA.com", "@tenantA.com"],
        },
        "expected_outcome": "success",
        "brd_refs": ["BR-DA-04", "BR-RB-06"],
        "concepts": ["Delegated Access", "Agent OAuth", "Whitelisted Resource"],
    },
    # --- UC-GLCHAT-01.3: Check internal colleague's calendar ---
    "UC-GLCHAT-01.3": {
        "product": "glchat",
        "title": "Check internal colleague's calendar (Admin)",
        "description": "Pak On (admin) checks Sandy's calendar. Agent OAuth with wildcard access.",
        "user_email": "onlee@tenantA.com",
        "agent": "scheduling-agent",
        "message": "Give me a list of Sandy's meetings today",
        "tool_inputs": {},
        "resource_context": {
            "target_calendar": "organiser@tenantA.com",
            "access_type": "agent",
            "agent_calendar_access": "*",
        },
        "expected_outcome": "success",
        "brd_refs": ["BR-DA-04", "BR-RB-06"],
        "concepts": ["Delegated Access", "Agent OAuth", "Internal Org"],
    },
    "UC-GLCHAT-01.3-M": {
        "product": "glchat",
        "title": "Check internal colleague's calendar (Member)",
        "description": "Petry (member) checks Sandy's calendar. Agent OAuth allowed — target is in the same org.",
        "user_email": "attendee@tenantA.com",
        "agent": "scheduling-agent",
        "message": "Give me a list of Sandy's meetings today",
        "tool_inputs": {},
    ...
    "UC-GLCHAT-01.4": {
        ...
        "description": "Pak On (admin) checks Charlie's calendar (external org). Agent OAuth with wildcard — admin can access any calendar.",
        "user_email": "onlee@tenantA.com",
        "agent": "scheduling-agent",
        "message": "Give me a list of Charlie's meetings today",
        "tool_inputs": {},
        "resource_context": {
            "target_calendar": "charlie@tenantB.com",
            "access_type": "agent",
            "agent_calendar_access": "*",
        },
        "expected_outcome": "success",
        "brd_refs": ["BR-DA-04", "BR-RB-06", "BR-RB-07"],
        "concepts": ["Delegated Access", "Agent OAuth", "Cross-Org Access"],
    },
    "UC-GLCHAT-01.4-M": {
        "product": "glchat",
        "title": "Check external org colleague's calendar (Member, rejected)",
        "description": "Petry (member) tries to check Charlie's calendar (external org). Rejected — member's resource constraint only allows internal org.",
        "user_email": "attendee@tenantA.com",
        "agent": "scheduling-agent",
        "message": "Give me a list of Charlie's meetings today",
        "tool_inputs": {},
        ...
        "concepts": ["Resource Constraint", "Org Boundary Enforcement"],
    },
    "UC-GLCHAT-02.1": {
        "product": "glchat",
    ...
    "UC-GLCHAT-02.2": {
        "product": "glchat",
        "title": "Write to colleague's calendar (Admin, rejected)",
        "description": "Alice (admin) tries to write to Sandy's calendar. Rejected — resource constraint.",
        "user_email": "onlee@tenantA.com",
        "agent": "scheduling-agent",
        ...
        "tool_inputs": {
            "calendar.create_event": {
                ...
                "target_calendar": "sandy@tenantA.com",
            },
        },
        "resource_context": {
            "target_calendar": "sandy@tenantA.com",
            "access_type": "user",
            "write_to_others": True,
        },
        "expected_outcome": "rejected",
        "brd_refs": ["BR-RB-02", "BR-DA-02"],
        "concepts": ["Resource Constraint", "Write Protection"],
    },
    # --- Member variant: Petry tries to write to colleague's calendar ---
    "UC-GLCHAT-02.2-M": {
        "product": "glchat",
        "title": "Write to colleague's calendar (Member, rejected)",
        "description": "Petry (member) tries to write to Sandy's calendar. Also rejected — same resource constraint applies regardless of role.",
        "user_email": "attendee@tenantA.com",
        "agent": "scheduling-agent",
        "message": "Add a dentist appointment to Sandy's calendar tomorrow at 10am",
        "tool_inputs": {
        ...
        "expected_outcome": "rejected",
        "brd_refs": ["BR-RB-02", "BR-DA-02"],
        "concepts": ["Resource Constraint", "Write Protection", "Same Rejection for All Roles"],
    },
    "UC-GLCHAT-03.1": {
        "product": "glchat",
    ...
    "UC-GLCHAT-03.2": {
        ...
        "user_email": "deactivated@tenantA.com",
        "agent": "scheduling-agent",
        "message": "Send daily meeting list (scheduled task)",
        "tool_inputs": {},
        "resource_context": {
            "target_calendar": "deactivated@tenantA.com",
            "access_type": "user",
            "scheduled_task": True,
        },
        "expected_outcome": "rejected",
    ...
    "UC-DE-01.1": {
        ...
        "user_email": "organiser@tenantA.com",
        "agent": "de-pm-agent",
        ...
        "resource_context": {
            "meeting_id": "meet-001",
            "organiser_email": "organiser@tenantA.com",
            "access_type": "agent",
        },
        "expected_outcome": "success",
    ...
    "UC-DE-01.2": {
        ...
        "resource_context": {
            "meeting_id": "meet-002",
            "organiser_email": "no-meemo@tenantA.com",
            "access_type": "agent",
        },
    ...
    "UC-DE-02.1": {
        ...
        "resource_context": {
            "mom_id": "mom-001",
            "requester_email": "organiser@tenantA.com",
            "access_type": "user",
        },
        "expected_outcome": "success",
    ...
    "UC-DE-02.2": {
        ...
        "resource_context": {
            "mom_id": "mom-001",
            "requester_email": "attendee@tenantA.com",
            "access_type": "user",
        },
        "expected_outcome": "rejected",
    ...
    "UC-DE-02.4": {
        ...
        "tool_inputs": {
            "gdoc.share": {
                "mom_id": "mom-001",
                "recipients": ["attendee@tenantA.com", "external@external.com"],
            },
        },
        "resource_context": {
            "mom_id": "mom-001",
    ...
    "UC-DE-03.2": {
        ...
        "user_email": "dept-head@tenantA.com",
        "agent": "de-pm-agent",
        "message": "Summarize yesterday's GL IAM standup",
        "tool_inputs": {
            "meemo.read_mom": {"mom_id": "mom-001"},
        ...
        "resource_context": {
            "mom_id": "mom-001",
            "requester_email": "dept-head@tenantA.com",
            "access_type": "agent",
        },
        "expected_outcome": "success",
    ...
    "UC-DE-04.1": {
        ...
        "description": "Bob from Tenant B tries to invoke DE PM Agent in Tenant A.",
        "user_email": "bob@tenantB.com",
        "agent": "de-pm-agent",
        "message": "Summarize yesterday's GL IAM standup",
        "tool_inputs": {},
        "resource_context": {
    ...
    "UC-DE-06.2": {
        ...
        "user_email": "other-pm@tenantA.com",
        "agent": "de-pm-agent",
        "message": "Send all AWS invoices April 2026",
        "tool_inputs": {
            "invoice.send": {"invoice_id": "inv-aws-2026-04"},
    ...
    "UC-AIP-01.1": {
        ...
        "tool_inputs": {
            "gdoc.read": {"report_email": "onlee@tenantA.com"},
            "gmail.send": {"to": "manager@tenantA.com"},
        },
        "resource_context": {
            "report_email": "onlee@tenantA.com",
            "access_type": "agent",
            "autonomous": True,
        },
        "expected_outcome": "success",
    ...
    "UC-AIP-01.2": {
        ...
        "user_email": None,
        "agent": "weekly-report-agent",
        "message": "Send final weekly report for bob@tenantA.com",
        "tool_inputs": {
            "gdoc.read": {"report_email": "bob@tenantA.com"},
            "gmail.send": {"to": "manager@tenantA.com"},
        },
        "resource_context": {
            "report_email": "bob@tenantA.com",
            "access_type": "agent",
            "autonomous": True,
        },
        "expected_outcome": "success",
    ...
    "UC-AIP-02.1": {
        ...
        "tool_inputs": {
            ...
            "gmail.send": {"to": "onlee@tenantA.com"},
        },
        "resource_context": {
            "report_email": "onlee@tenantA.com",
            "access_type": "agent",
    ...
    "UC-AIP-02.2": {
        ...
        "user_email": None,
        "agent": "weekly-report-agent",
        "message": "Send draft weekly report to resigned@tenantA.com",
        "tool_inputs": {
            "gdoc.create": {"title": "Draft Weekly Report"},
            "gmail.send": {"to": "resigned@tenantA.com"},
        },
        "resource_context": {
            "report_email": "resigned@tenantA.com",
            "access_type": "agent",
            "autonomous": True,
        },
