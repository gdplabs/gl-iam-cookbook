...
SCENARIOS: dict[str, dict] = {
    ...
    "UC-GLCHAT-01.1": {
        ...
        "user_email": "alice@tenantA.com",
        "agent": "scheduling-agent",
        "message": "Give me a list of my meetings today",
        "tool_inputs": {},
        "resource_context": {
            "target_calendar": "alice@tenantA.com",
            "access_type": "user",
        },
    ...
    "UC-GLCHAT-01.2": {
        "product": "glchat",
        "title": "Check colleague's calendar (Admin)",
        "description": "Alice (admin) checks Pak On's meetings. Agent uses its own OAuth authorization.",
        "user_email": "alice@tenantA.com",
        "agent": "scheduling-agent",
        "message": "Give me a list of Pak On's meetings today",
        "tool_inputs": {},
        "resource_context": {
            "target_calendar": "pakon@tenantA.com",
            "access_type": "agent",
        },
        "expected_outcome": "success",
        "brd_refs": ["BR-DA-04", "BR-AP-01"],
        "concepts": ["Delegated Access", "Agent OAuth (Admin)"],
    },
    # --- Member variant: Petry tries to check colleague's calendar ---
    "UC-GLCHAT-01.2-M": {
        "product": "glchat",
        "title": "Check colleague's calendar (Member)",
        "description": "Petry (member) tries to check Pak On's meetings. Member cannot use Agent OAuth — must use own User OAuth which has no access to others' calendars.",
        "user_email": "attendee@tenantA.com",
        "agent": "scheduling-agent",
        "message": "Give me a list of Pak On's meetings today",
        "tool_inputs": {},
        ...
        "expected_outcome": "success",
        "brd_refs": ["BR-DA-02", "BR-RB-01"],
        "concepts": ["Delegated Access", "User OAuth Only (Member)", "No Agent Elevation"],
    },
    "UC-GLCHAT-02.1": {
        "product": "glchat",
    ...
    "UC-AIP-01.1": {
        ...
        "message": "Send final weekly report for alice@tenantA.com",
        "tool_inputs": {
            "gdoc.read": {"report_email": "alice@tenantA.com"},
            "gmail.send": {"to": "manager@tenantA.com"},
        },
        "resource_context": {
            "report_email": "alice@tenantA.com",
            "access_type": "agent",
            "autonomous": True,
        },
        "expected_outcome": "success",
    ...
    "UC-AIP-02.1": {
        ...
        "user_email": None,
        "agent": "weekly-report-agent",
        "message": "Send draft weekly report to alice@tenantA.com",
        "tool_inputs": {
            "gdoc.create": {"title": "Draft Weekly Report"},
            "gmail.send": {"to": "alice@tenantA.com"},
        },
        "resource_context": {
            "report_email": "alice@tenantA.com",
            "access_type": "agent",
