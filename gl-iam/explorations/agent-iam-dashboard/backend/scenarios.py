...
SCENARIOS: dict[str, dict] = {
    ...
    "UC-GLCHAT-01.2": {
        "product": "glchat",
        "title": "Check colleague's calendar schedule",
        "description": "Alice checks Pak On's meetings. Agent uses its own authorization.",
        "user_email": "alice@tenantA.com",
        "agent": "scheduling-agent",
        ...
        "concepts": ["Delegated Access", "Agent Authorization"],
    },
    "UC-GLCHAT-02.1": {
        "product": "glchat",
        "title": "Schedule meeting on own calendar",
        "description": "Alice schedules a meeting on her own calendar with Sandy and Petry.",
        "user_email": "alice@tenantA.com",
        "agent": "scheduling-agent",
    ...
    "UC-GLCHAT-02.2": {
        "product": "glchat",
        "title": "Write to colleague's calendar (rejected)",
        "description": "Alice tries to add an event to Sandy's calendar. Rejected - no write permission.",
        "user_email": "alice@tenantA.com",
        "agent": "scheduling-agent",
